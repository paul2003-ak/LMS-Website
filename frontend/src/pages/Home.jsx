  ...
  return (
    <div className=' w-[100%] overflow-hidden '>
      <div className=' w-[100%] lg:h-[140vh] h-[70vh] relative '>
        <Nav />
        <img src={home1} className=" object-cover md:object-full w-[100%] lg:h-[100%] h-[50vh] " alt="" />
        ...
        <span className=' lg:text-70px  absolute md:text-[40px] lg:top-[15%] top-[20%] w-[100%] flex items-center justify-center text-white font-bold text-[20px] '>Your Career Path</span>

        <div className=' absolute lg:top-[30%] top-[75%] md:top-[80%] w-[100%] flex items-center justify-center gap-3 flex-wrap '>
          <button onClick={()=>navigate('/allcourses')} className='px-[20px] py-[10px] border-2 lg:border-white border-black lg:text-white text-black rounded-[10px] text-[18px] font-light flex gap-2 cursor-pointer'>
            View All Courses
