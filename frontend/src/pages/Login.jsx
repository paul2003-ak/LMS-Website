...
const Login = () => {
    ...
    const handleLogin = async (e) => {
        ...
        try {
            ...
            dispatch(setuserData(result.data));//redux action to set user data
        ...
        <div className=' bg-[#dddbdb] w-[100vw] h-[100vh] flex items-center justify-center '>
            ...
            <form onSubmit={handleLogin} className=' w-[90%] md:w-200 h-150 bg-[white] shadow-xl rounded-2xl flex '>
                ...
                <div className=' md:w-[50%] w-[100%] h-[100%] flex flex-col items-center justify-center gap-3 '>
                    ...
                    {/* Forgot password */}
                    <span onClick={()=>navigate('/forgotpassword')} className=' tetx-[13px] cursor-pointer text-[#585757] '>Forget your password ?</span>
                    ...
                    {/* google */}
                    <div onClick={Googlelogin} className=' cursor-pointer w-[80%] h-[40px] border-1 border-[black] flex items-center justify-center '>
                        <img src={google} className=' w-[25px] ' alt="" />
                        <span className=' text-[18px] text-gray-500 '>oogle</span>
                    </div>

                    <div className='  text-[#6f6f6f]  '>
                        Create new account <span onClick={() => navigate('/signup')} className=' text-black cursor-pointer hover:underline '>SignUp</span>
                    </div>
